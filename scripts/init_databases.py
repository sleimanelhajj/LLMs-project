...
def create_catalog_database():
    ...
    products = [
        ...
        (
            "SS-CABLE-3MM",
            "Stainless Steel Cable 3mm 7x19",
            "Wire",
        ...
        (
            "SS-CABLE-5MM",
            "Stainless Steel Cable 5mm 7x19",
            "Wire",
        ...
        (
            "NY-BAG-L",
            "Heavy-Duty Nylon Storage Bag Large",
            "Bags",
        ...
        (
            "NY-BAG-M",
            "Heavy-Duty Nylon Storage Bag Medium",
            "Bags",
        ...
        (
            "NY-BAG-S",
            "Heavy-Duty Nylon Storage Bag Small",
            "Bags",
        ...
        (
            "SF-HARNESS-STD",
            "Full Body Safety Harness - Standard",
            "Safety",
        ...
        (
            "SF-HARNESS-PRO",
            "Full Body Safety Harness - Professional",
            "Safety",
        ...
        (
            "HW-HOOK-SS-10",
            "Snap Hook Stainless Steel 10mm",
            "Hardware",
        ...
        (
            "HW-HOOK-SS-12",
            "Snap Hook Stainless Steel 12mm",
            "Hardware",
        ...
        (
            "BX-CARD-L",
            "Heavy-Duty Cardboard Box Large",
            "Packaging",
        ...
        (
            "BX-CARD-M",
            "Heavy-Duty Cardboard Box Medium",
            "Packaging",
        ...
        (
            "BX-CARD-S",
            "Heavy-Duty Cardboard Box Small",
            "Packaging",
...
def create_orders_database():
    ...
    customers = [
        ...
        (
            "CUST-004",
            "Emily Davis",
            "emily.davis@warehouse.net",
            "+1-555-0104",
            "Davis Warehouse Solutions",
            "321 Storage Blvd",
            "Chicago",
            "USA",
        ),
...
def initialize_vector_database():
    ...
    try:
        ...
        if not os.path.exists(docs_dir):
            ...
            print(
                "  Note: Add company documents (.pdf, .txt, .md) to this directory for RAG functionality"
            )
            return True

        # Check if there are any documents
        doc_files = [
            f for f in os.listdir(docs_dir) if f.endswith((".pdf", ".txt", ".md"))
        ]
        if not doc_files:
        ...
        print(
            "  The system will still work, but RAG-based company document search will not be available"
        )
